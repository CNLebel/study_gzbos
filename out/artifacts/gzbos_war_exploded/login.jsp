...
<title>登陆页面</title>
<script src="${pageContext.request.contextPath }/js/easyui/jquery.min.js" type="text/javascript"></script>
...
<body>
	...
	<div
		...
		<span style="color: #488ED5;"></span><span
			style="color: #488ED5;margin-left:10px;"><a
			href="http://download.firefox.com.cn/releases/full/23.0/zh-CN/Firefox-full-latest.exe"></a>
